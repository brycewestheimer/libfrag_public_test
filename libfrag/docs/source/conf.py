...
exhale_args = {
    ...
    "rootFileName":          "libfrag_api.rst",
    "rootFileTitle":         "libfrag API",
...
breathe_default_project = 'libfrag'

templates_path = ['_template']
source_suffix = '.rst'
master_doc = 'index'
project = 'libfrag'
copyright = ' 2025 , Bryce Westheimer'
