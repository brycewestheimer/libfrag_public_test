...
============
    ...
    * Continous Integration:
        * `azure-pipelines <https://dev.azure.com/brycewestheimer/libfrag/_build/latest?definitionId=1&branchName=master>`_
        * `circle-ci <https://circleci.com/gh/brycewestheimer/libfrag/tree/master>`_
        * `travis-ci <https://travis-ci.org/brycewestheimer/libfrag>`_
    * bumpversion for version handling
    * Documentation with sphinx breathe and on
      `readthedocs <http://libfrag.readthedocs.io/en/latest/?badge=latest>`_
